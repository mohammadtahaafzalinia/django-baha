...
var setBlogOffset = function(){
	var $offset = $blog_container.parent().css('padding-right');
	if($blog_container.css('position') == 'absolute'){
		$blog_container.css('right', $offset);
	}
	else {
		$blog_container.css('right', 'auto');
	}
}
...
var setBlogListOffset = function(){
	var $offset = $blog_list_container.parent().css('padding-right');
	if($blog_list_container.css('position') == 'absolute'){
		$blog_list_container.css('right', $offset);
	}
	else {
		$blog_list_container.css('right', 'auto');
	}
}
